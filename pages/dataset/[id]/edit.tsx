...
export default function EditDataset() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                // Fetch organizations
                const orgsRes = await axios.get(`${CKAN_API}/action/organization_list`, {
                ...
                const datasetRes = await axios.get(`${CKAN_API}/action/package_show`, {
                    params: { id },
                    headers: { Authorization: apiKey }
                });
    ...
    const handleUpdate = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await axios.post(
                `${CKAN_API}/action/package_update`,
                packageData,
                {
                    headers: { Authorization: apiKey },
                }
